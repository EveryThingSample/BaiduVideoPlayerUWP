...
namespace EveryThingSampleTools.UWP.NetdiskOpenAPI
{
    ...
    public interface INetdiskItem2 : INetdiskItem
    {
        ...
        /// </summary>
        /// <returns></returns>
        IAsyncOperation<NetdiskFolder> GetParentAsync();
    ...
    {
        IAsyncOperation<NetdiskFolder> CreateFolderAsync(string desiredName);
        IAsyncOperation<NetdiskFile> GetFileAsync(string name);
        IAsyncOperation<NetdiskFolder> GetFolderAsync(string name);
        ...
        IAsyncOperation<IReadOnlyList<NetdiskFile>> GetFilesAsync();

        IAsyncOperation<IReadOnlyList<NetdiskFolder>> GetFoldersAsync();
